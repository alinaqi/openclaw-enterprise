...
export const TOOL_DISPLAY_CONFIG: ToolDisplayConfig = {
  ...
  tools: {
    ...
    asana_projects: {
      ...
      detailKeys: ["org", "workspace"],
    },
    asana_search: {
      title: "Asana Search",
      detailKeys: ["org", "query"],
    },
    asana_sprint_status: {
      title: "Asana Sprint",
      detailKeys: ["org", "project"],
    },
    asana_task_detail: {
      title: "Asana Task",
      detailKeys: ["org", "taskId"],
    },
    asana_tasks: {
      title: "Asana Tasks",
      detailKeys: ["org", "project", "assignee"],
    },
    calendar: {
      title: "Calendar",
      detailKeys: ["org", "action", "date"],
    },
    people_list: {
      title: "People List",
      detailKeys: ["org", "team"],
